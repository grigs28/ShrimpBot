...
This workspace is managed by **ShrimpBot** — an AI assistant accessible via Feishu/Telegram that runs Claude Code with full tool access.
...
### /shrimpbot — Agent Bus, Scheduling & Bot Management
...
For full API (create bots, update tasks, sendCards), use the `/shrimpbot` skill.
