...
metrics.counter('shrimpbot_tasks_total', 'Total number of tasks processed');
metrics.counter('shrimpbot_tasks_by_status', 'Tasks by completion status');
metrics.counter('shrimpbot_commands_total', 'Total slash commands processed');
metrics.counter('shrimpbot_auth_denied_total', 'Total auth denied events');
metrics.counter('shrimpbot_api_tasks_total', 'Total API tasks processed');
metrics.gauge('shrimpbot_active_tasks', 'Currently running tasks');
metrics.gauge('shrimpbot_uptime_seconds', 'Process uptime in seconds');
metrics.histogram('shrimpbot_task_duration_seconds', 'Task duration in seconds', [1, 5, 10, 30, 60, 120, 300, 600, 1800, 3600]);
metrics.histogram('shrimpbot_task_cost_usd', 'Task cost in USD', [0.01, 0.05, 0.1, 0.5, 1, 5, 10]);
