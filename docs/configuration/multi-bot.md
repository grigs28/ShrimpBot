...
Run multiple Feishu and Telegram bots in a single ShrimpBot process.
...
| `outputsBaseDir` | No | `/tmp/shrimpbot-outputs` | Output files directory |
...
Without `BOTS_CONFIG`, ShrimpBot runs in single-bot mode using environment variables:
