...
The `mb` command provides terminal access to the ShrimpBot Agent Bus API.

## Installation

Installed automatically by the ShrimpBot installer to `~/.local/bin/mb`.
...
# In ~/.shrimpbot/.env or ~/shrimpbot/.env
SHRIMPBOT_URL=http://your-server:9100
